...
function Vd(e, t, a = ye) {
  const { immediate: r, deep: o, once: i, scheduler: n, augmentJob: l, call: s } = a, c = (v) => o ? v : ut(v) || o === !1 || o === 0 ? Ft(v, 1) : Ft(v);
  let d, u, p, h, f = !1, w = !1;
  if (Ve(e) ? (u = () => e.value, f = ut(e)) : ha(e) ? (u = () => c(e), f = !0) : re(e) ? (w = !0, f = e.some((v) => ha(v) || ut(v)), u = () => e.map((v) => {
    if (Ve(v))
      return v.value;
    if (ha(v))
      return c(v);
  ...
  return l && l(S), d = new Gn(u), d.scheduler = n ? () => n(S, !1) : S, h = (v) => Od(v, !1, d), p = d.onStop = () => {
    const v = Or.get(d);
    if (v) {
      if (s)
        s(v, 4);
  ...
  }, t ? r ? S(!0) : _ = d.run() : n ? n(S.bind(null, !0), !0) : d.run(), b.pause = d.pause.bind(d), b.resume = d.resume.bind(d), b.stop = b, b;
}
...
function Po(e, t, a, r, o) {
  const {
    ...
    const D = F[1];
    z(I, F), re(I) ? I.every((V) => V.length <= 1) && D() : I.length <= 1 && D();
  }, Z = {
    mode: n,
    persisted: l,
    beforeEnter(I) {
      ...
      const D = $[v];
      D && ca(e, D) && D.el[Dt] && D.el[Dt](), z(F, [I]);
    },
    enter(I) {
      let F = c, D = d, V = u;
      if (!a.isMounted)
      ...
      let M = !1;
      const W = I[gr] = (E) => {
        M || (M = !0, E ? z(V, [I]) : z(D, [I]), Z.delayedLeave && Z.delayedLeave(), I[gr] = void 0);
      };
      F ? X(F, [I, W]) : W();
    },
    leave(I, F) {
      ...
      let V = !1;
      const M = I[Dt] = (W) => {
        V || (V = !0, F(), W ? z(w, [I]) : z(f, [I]), I[Dt] = void 0, $[D] === e && delete $[D]);
      };
      $[D] = e, h ? X(h, [I, M]) : M();
    },
    clone(I) {
  ...
  if (ce(s))
    ...
    if (f || w) {
      const y = () => {
        ...
        } else f ? (d[s] = n, h(s) && (u[s] = n)) : w && (s.value = n, e.k && (d[e.k] = n));
      };
      if (n) {
        const b = () => {
          y(), Pr.delete(e);
...
function Xd(e) {
  ...
  if (Io = !0, i)
    for (const fe in i) {
      const le = i[fe], Ze = ce(le) ? le.bind(a, a) : ce(le.get) ? le.get.bind(a, a) : bt, Se = !ce(le) && ce(le.set) ? le.set.bind(a) : bt, Ie = P({
        get: Ze,
        set: Se
      });
  ...
  if (Q(Sl, u), Q(ot, p), Q(Cl, h), Q(Ud, f), Q(Fd, w), Q(Nd, y), Q(Wd, Z), Q(Kd, z), Q(Hd, X), Q(wa, _), Q(cr, v), Q(qd, I), re(F))
    if (F.length) {
  ...
  $ && e.render === bt && (e.render = $), D != null && (e.inheritAttrs = D), V && (e.components = V), M && (e.directives = M), I && _l(e);
}
...
function pc(e, t) {
  ...
  const {
    ...
    if (m == null)
      ...
      const L = x.el = m.el;
      x.children !== m.children && c(L, x.children);
    }
  }, b = (m, x, A, H) => {
    m == null ? r(
      x.el = s(x.children || ""),
    ...
    let de;
    if (A && na(A, !1), (de = ne.onVnodeBeforeUpdate) && At(de, A, x, m), se && ia(x, m, A, "beforeUpdate"), A && na(A, !0), (ae.innerHTML && ne.innerHTML == null || ae.textContent && ne.textContent == null) && d(J, ""), R ? F(
      m.dynamicChildren,
      R,
      J,
      A,
      ...
      G & 1 && m.children !== x.children && d(J, x.children);
    ...
    if (to(m) && (J.ctx.renderer = Ia), Oc(J, !1, te), J.asyncDep) {
    ...
    const J = () => {
      if (m.isMounted) {
        ...
        na(m, !1), be && kr(be), !$t && (ae = de && de.onVnodeBeforeMount) && At(ae, $e, x), na(m, !0);
        {
    ...
    m.vnode = x, m.next = null, nc(m, x.props, H, A), cc(m, x.children, A), Ut(), Ii(m), qt();
    ...
    de & 8 ? (se & 16 && ge(R, L, N), ae !== R && d(A, ae)) : se & 16 ? de & 16 ? Se(
      R,
      ae,
      A,
      H,
    ...
    if (R > ae) {
      ...
      for (R = de; R <= ae; R++) {
        ...
        if (et.key != null)
          ...
          for ($e = be; $e <= ne; $e++)
            if (ja[$e - be] === 0 && ca(et, x[$e])) {
              Ct = $e;
              break;
            }
        Ct === void 0 ? Oe(et, L, N, !0) : (ja[Ct - be] = R + 1, Ct >= St ? St = Ct : $t = !0, w(
          et,
          x[Ct],
          A,
          null,
    ...
    qi(G), qi(R), H && kr(H), L.stop(), N && (N.flags |= 8, Oe(te, m, x, A)), J && tt(J, x), tt(() => {
      m.isUnmounted = !0;
    }, x);
    ...
    const x = p(m.anchor || m.el), A = x && x[Bd];
    return A ? p(A) : x;
  };
  let ya = !1;
  const Ai = (m, x, A) => {
  ...
  const r = _t(), o = Ue(t), i = Xe(t), n = Hl(e, o), l = Sd((s, c) => {
    ...
    return gc(() => {
      ...
      set(h) {
        ...
        (t in w || o in w || i in w) && (`onUpdate:${t}` in w || `onUpdate:${o}` in w || `onUpdate:${i}` in w) || (d = h, c()), r.emit(`update:${t}`, f), Ye(h, f) && Ye(h, u) && !Ye(f, p) && c(), u = h, p = f;
      }
    };
  });
...
function Hi(e) {
  ...
  return a.dirs && (S = Qt(S, null, !1, !0), S.dirs = S.dirs ? S.dirs.concat(a.dirs) : a.dirs), a.transition && Xa(S, a.transition), b = S, Mr(y), b;
}
const xc = (e) => {
  let t;
  for (const a in e)
...
function Uc(e) {
  ...
  const {
    ...
    V._enterCancelled = E, sa(V, M ? d : l), sa(V, M ? c : n), W && W();
  }, F = (V, M) => {
    V._isLeaving = !1, sa(V, u), sa(V, h), sa(V, p), M && M();
  }, D = (V) => (M, W) => {
    const E = V ? X : _, Q = () => I(M, V, W);
    la(E, [M, Q]), Xi(() => {
      sa(M, V ? s : i), It(M, V ? d : l), Yi(E) || Qi(M, r, w, Q);
    });
  };
  return Ee(t, {
    onBeforeEnter(V) {
      la(b, [V]), It(V, i), It(V, n);
    },
    onBeforeAppear(V) {
      la(z, [V]), It(V, s), It(V, c);
    },
    onEnter: D(!1),
    onAppear: D(!0),
    onLeave(V, M) {
      V._isLeaving = !0;
      const W = () => F(V, M);
      It(V, u), V._enterCancelled ? (It(V, p), an(V)) : (an(V), It(V, p)), Xi(() => {
        V._isLeaving && (sa(V, u), It(V, h), Yi(v) || Qi(V, r, y, W));
      }), la(v, [V, W]);
    },
    onEnterCancelled(V) {
      I(V, !1, void 0, !0), la(S, [V]);
    },
    onAppearCancelled(V) {
      I(V, !0, void 0, !0), la(Z, [V]);
    },
    onLeaveCancelled(V) {
      F(V), la($, [V]);
    }
...
const he = (e, t) => {
  ...
  setup(e, { emit: t }) {
    ...
    return (n, l) => (g(), C("div", Bu, [
      (g(!0), C(xe, null, Xt(e.items, (s, c) => ie(n.$slots, "default", Me({
        key: c,
        ref_for: !0
...
function qu(e, t, a, r, o, i, n, l, s) {
  ...
  return c.length ? (c.forEach((w) => {
    f[w] = Nu(e[w], t, f.$dirty, i, n, w, a, o, s, p, h);
    ...
    const w = c.some((y) => k(f[y].$invalid));
...
function Ku(e, t, a) {
  const r = P(() => [t, a].filter((f) => f).reduce((f, w) => f.concat(Object.values(k(w))), [])), o = P({
    ...
    return f.concat(w);
  }), l = P(() => r.value.some((f) => f.$invalid) || k(e.$invalid) || !1), s = P(() => r.value.some((f) => k(f.$pending)) || k(e.$pending) || !1), c = P(() => r.value.some((f) => f.$dirty) || r.value.some((f) => f.$anyDirty) || o.value), d = P(() => o.value ? s.value || l.value : !1), u = () => {
...
function qo(e) {
  ...
  }), S = qu(u, y, r, n, d, w, s, _, a), v = Hu(p, y, d, n, w, s, _), $ = {};
  f && Object.entries(f).forEach((Se) => {
    let [Ie, Oe] = Se;
    $[Ie] = {
      $invalid: _o(Oe, v, "$invalid"),
      $error: _o(Oe, v, "$error"),
      $pending: _o(Oe, v, "$pending"),
  ...
  const {
    ...
    set: (Se) => {
      z.value = !0;
      const Ie = k(a), Oe = k(c);
      Oe && (Oe[r] = b[r]), Ve(Ie[r]) ? Ie[r].value = Se : Ie[r] = Se;
    }
  }) : null;
  r && w.$autoDirty && ue(y, () => {
    z.value || V();
  ...
  function Ze() {
    Ve(c) ? c.value = b : Object.keys(b).length === 0 ? Object.keys(c).forEach((Se) => {
      delete c[Se];
    }) : Object.assign(c, b);
  }
...
function Zu(e) {
  ...
  const r = {}, o = q([]), i = P(() => o.value.reduce((d, u) => (d[u] = k(r[u]), d), {}));
  function n(d, u) {
    let {
      $registerAs: p,
      $scope: h,
...
function aa(e, t) {
  ...
  if (!e && d.validations) {
    ...
    t = q({}), Sl(() => {
      t.value = c, ue(() => Rr(y) ? y.call(t.value, new ps(t.value)) : y, (b) => {
        u.value = qo({
          validations: b,
          state: t,
          childResults: h,
  ...
  return c && (f.forEach((y) => y(u, {
    ...
    $scope: i,
    $stopPropagation: n
  })), wa(() => w.forEach((y) => y(o)))), P(() => Yt(Yt({}, k(u.value)), h.value));
}
function $n(e, t) {
  var a = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
function Yu(e, t) {
  if (!Ur(e) && typeof k(e) != "string") throw new Error(`[@vuelidate/validators]: First parameter to "withMessage" should be string or a function returning a string, provided ${typeof e}`);
  if (!Ho(t) && !Ur(t)) throw new Error("[@vuelidate/validators]: Validator must be a function or object with $validator parameter");
  const a = so(t);
    ...
    $validator(t) {
      ...
      return k(t).reduce((i, n, l) => {
        const s = Object.entries(n).reduce((c, d) => {
          let [u, p] = d;
          const h = e[u] || {}, f = Object.entries(h).reduce((w, y) => {
            let [b, _] = y;
            const S = hs(_).call(this, p, n, l, ...r), v = fs(S);
...
const xp = { class: "amount-input-container" }, kp = ["disabled", "aria-label"], _p = ["id", "disabled", "aria-invalid", "aria-describedby"], $p = ["disabled", "aria-label"], Sp = ["id"], Cp = {
  ...
  setup(e, { emit: t }) {
    ...
    const p = P(() => a.required ? { value: { required: Ke.withMessage(() => j("input.required"), ir) } } : { value: {} }), h = aa(p.value, { value: o });
    return (f, w) => (g(), C("div", xp, [
      T("div", {
        ...
        T("button", {
          ...
          class: "minus",
          "aria-label": k(j)("amount-input.minus_one"),
          onClick: We(d, ["stop"])
        }, [
          e.small ? (g(), Y(yt, {
            key: 1,
        ...
        T("button", {
          ...
          class: "plus",
          "aria-label": k(j)("amount-input.plus_one"),
          onClick: We(u, ["stop"])
        }, [
          e.small ? (g(), Y(yt, {
            key: 1,
...
function yi(e = {}) {
  ...
  function f(_, S, v) {
    if (!(!_ || typeof S.getModifierState != "function")) {
      for (const [$, z] of d) if (S.getModifierState($)) {
        v.forEach((X) => z.add(X));
        break;
      }
    }
  ...
  function y(_, S) {
    ...
    for (const Z of X)
      u.add(Z), p(Z, S);
    f(S, _, [...n, ...X]), w(S, z), z === "meta" && !S && (c.forEach((Z) => {
      n.delete(Z), p(Z, !1);
    }), c.clear());
  }
...
const $f = ["aria-hidden", "aria-label"], Sf = { class: "floating-container-overlay" }, Cf = ["aria-expanded"], Af = {
  ...
  setup(e, { expose: t, emit: a }) {
    const r = e, o = a, i = Tt("floating-container-content"), n = q(null), { autoUpdate: l, fixedPosition: s, watchCursor: c, placement: d, alignment: u } = _f(
      i,
      n
    ), p = /* @__PURE__ */ Lp(), h = q(!1), f = q(!1), w = q(-1), y = P(() => p.value === n.value || p.value === i.value || n.value?.contains(p.value) || i.value?.contains(p.value) || !1), b = P(() => {
      switch (r.behavior) {
        case "focus":
    ...
    return ot(async () => {
      ...
      b.value ? (g(), Y(Ma(b.value.component), Me({ key: 0 }, b.value.props, {
        ...
        default: O(({ slotProps: V }) => [
          ie(F.$slots, "activator", Va(no({ ...V, onKeydown: Z })), void 0, !0)
        ]),
        _: 3
      }, 16, ["model-value"])) : U("", !0),
      h.value ? (g(), C("div", {
  ...
  setup(e, { expose: t, emit: a }) {
    const r = e, o = Qe(e, "modelValue"), i = El(), n = a, l = Rt("showError", !0), s = yi()[r.hotkey.key], c = q(null), d = P(() => r.error ? Hp : r.icon), u = P(() => r.optional !== "" ? r.optional : j("input.optional")), p = P(() => r.requiredMessage ? r.requiredMessage : r.label ? j("input.required_with_label", { label: r.label.toLowerCase() }) : j("input.required")), h = P(() => {
    ...
    return ue(s, (_) => {
      ...
      e.label ? (g(), C("label", {
        ...
        e.required ? U("", !0) : (g(), C("span", Vf, B(u.value), 1))
      ], 8, Ef)) : U("", !0),
      T("div", Mf, [
...
const ah = ["id"], rh = { class: "header" }, oh = {
  ...
  setup(e, { emit: t }) {
    const a = e, r = t, o = Tt("measurements-form"), i = q({}), n = Be({
      ...
      const v = a.options.find((I) => I.code === "width"), $ = a.options.find((I) => I.code === "height"), z = v && v.reversible && $ && $.reversible, X = v?.min, Z = $?.min;
      return z ? Math.min(X, Z) : { width: X, height: Z };
    }), d = P(() => {
      const v = a.options.find((I) => I.code === "width"), $ = a.options.find((I) => I.code === "height"), z = v && v.reversible && $ && $.reversible, X = v?.max, Z = $?.max;
      ...
      width: {
        ...
        required: Ke.withMessage(j("step.required"), ir),
        maxValue: Ke.withMessage(
          j("step.max_value", {
            maxValue: typeof d.value == "number" ? d.value : d.value.width
          }),
          Hr(typeof d.value == "number" ? d.value : d.value.width)
        )
      },
      height: {
        minValue: Ke.withMessage(
        ...
        maxValue: Ke.withMessage(
          ...
          Hr(typeof d.value == "number" ? d.value : d.value.height)
        )
      }
    }, p = aa(u, n), h = q(null), f = P(() => a.buttonStartText || j("step.new_configuration")), w = P(() => {
      if (a.code === "measurement-amount") {
        ...
        if (v && (!n.width || p.value.$errors.some((X) => X.$property === "width")) || $ && (!n.height || p.value.$errors.some((X) => X.$property === "height")) || z && !l.value)
          return !0;
      }
      return a.code === "amount" && !l.value;
    });
    function y(v, $) {
      if (v && $ && (!p.$errors || p.$errors.length === 0)) {
    ...
    return ot(() => {
      ...
      () => a.modelValue,
      (v) => {
        v?.length && (n.width = v.find(($) => $.code === "width")?.value, n.height = v.find(($) => $.code === "height")?.value, l.value = v.find(($) => $.code === "amount")?.value || 1, p.value.$touch());
      },
      { immediate: !0 }
    ), (v, $) => (g(), C("div", {
      id: "accordion-header-" + e.ariaTitle,
      ...
      T("div", rh, [
        ...
        T("div", {
          ...
          T("h3", oh, [
            ...
            e.hasOverwrites && e.editor ? (g(), Y(nr, {
              key: 0,
              text: k(j)("option.step_has_overwrites")
            }, {
              default: O(() => [
            ...
            e.isHidden && e.editor ? (g(), Y(nr, {
              key: 1,
              text: k(j)("option.step_is_hidden")
            }, {
              default: O(() => [
          ...
          K(Ss, {
            ...
            default: O(() => [
              T("div", {
                class: pe(["measurement-inputs", { "has-errors": k(p).$errors && k(p).$errors.length }])
              }, [
                (g(!0), C(xe, null, Xt(e.options, (z, X) => (g(), C(xe, { key: X }, [
                  z.code === "width" || z.code === "height" ? (g(), Y(mt, {
                    ...
                    min: z.min,
                    max: z.max,
                    placeholder: k(j)(`step.${z.code}`),
                    error: k(p)[z.code].$errors ? k(p)[z.code].$errors[0]?.$message : "",
                    onBlur: (Z) => {
                      k(p)[z.code].$touch(Z), S(!1);
                    },
                    onKeyup: dt(We((Z) => {
                      k(p)[z.code].$touch(Z), b();
                    }, ["stop"]), ["enter"]),
                    onFocus: $[1] || ($[1] = (Z) => S(!0))
        ...
        e.editor ? (g(), Y(Pe, {
          ...
          default: O(() => [
            oe(B(k(j)("option.edit")), 1)
          ]),
          _: 1
        })) : U("", !0),
        s.value ? (g(), C("span", lh, B(e.totalPrefix || k(j)("step.total")) + ": " + B(s.value) + " m² ", 1)) : U("", !0)
      ]),
      e.alert ? (g(), C("div", sh, [
        K(lr, Va(no(e.alert)), null, 16)
      ])) : U("", !0)
    ], 10, ah));
  }
  ...
  setup(e) {
    ...
    return (a, r) => (g(), C(xe, null, [
      ...
      e.image && !e.editAmount ? (g(), Y(As, {
        key: 2,
        image: e.image,
        alt: `${e.title} ${k(j)("option.product_photo")}`,
        width: "280"
...
const _h = {
  ...
  setup(e, { emit: t }) {
    ...
    return (l, s) => e.disabled && e.notAvailableMessage ? (g(), C("div", _h, [
      ...
      K(mt, {
        ...
        "aria-label": k(j)("option.custom_value")
      ...
      K(Pe, {
        ...
        default: O(() => [
          oe(B(e.customInput.buttonText || k(j)("option.continue")), 1)
        ]),
        _: 1
      })
    ])) : (g(), C("div", Sh, [
  ...
  key: 1,
  class: "inner"
}, Bh = { class: "header" }, Ih = { class: "content" }, jh = {
  key: 0,
  class: "title",
  part: "option-title"
}, Dh = {
  ...
  setup(e) {
    const t = e, a = q(!1), r = P(() => t.deliveryTimeText !== "" ? `${t.deliveryTime} ${t.deliveryTimeText}` : yp("option.days", t.deliveryTime)), o = P(() => {
      switch (t.pricePer) {
        case "unit":
          return j("option.per_unit");
        case "meter":
          return "m";
        default:
          return "m²";
      }
    }), i = Qe(e, "modelValue"), n = Qe(e, "amount"), l = P(() => t.amountLabel ? t.amountLabel : j("option.amount")), s = P(() => typeof n.value == "number" && n.value > 0);
    function c(p) {
    ...
    function u(p, h) {
      ...
      if (h === "left") {
        ...
        w ? w.classList.contains("disabled") ? u({ currentTarget: w }, "left") : y ? y.click() : w.focus() : d(f.closest(".accordion-item"), "left");
      } else if (h === "right") {
        const w = f.nextElementSibling?.querySelector(".option-card"), y = f.nextElementSibling?.querySelector(".overlay");
        w ? w.classList.contains("disabled") ? u({ currentTarget: w }, "right") : y ? y.click() : w.focus() : d(f.closest(".accordion-item"), "right");
      }
    }
    return ot(() => {
      ...
      e.noOption ? (g(), C("div", Mh, [
        ...
        T("div", Ih, [
          ie(p.$slots, "content", {}, () => [
            e.title ? (g(), C("h3", jh, B(e.title), 1)) : U("", !0),
    ...
    return p(), ue(
      ...
      K(ls, {
        ...
        header: O(() => [
          ...
          e.status === "attention" ? (g(), C("span", Kh, B(e.attentionText || k(j)("option.attention")), 1)) : U("", !0),
            ...
            T("div", {
              ...
              (g(!0), C(xe, null, Xt(e.options, (S, v) => (g(), C("div", {
                ...
                K(Nh, Me({
                  ...
                  "not-available-message": S.available === !1 ? e.unvailableText || k(j)("option.unavailable") : "",
                  "model-value": n.value[v],
                  exportparts: "option option-title option-description",
                  "onUpdate:amount": ($) => f(v, $),
                  "onUpdate:modelValue": ($) => u(v)
  ...
  setup(e) {
    const t = e, a = q(!1), r = P(() => t.title ? t.title : j("delivery.delivery_options")), o = P(() => t.noCost ? t.noCost : j("delivery.no_extra_cost")), i = P(
      () => t.makeYourChoice ? t.makeYourChoice : j("delivery.make_your_choice_next_step")
    ), n = P(() => t.buttonTextShow ? t.buttonTextShow : j("delivery.see_more")), l = P(() => t.buttonTextHide ? t.buttonTextHide : j("delivery.see_less"));
    function s() {
    ...
    return rt(() => {
      ...
      T("div", ev, [
        (g(!0), C(xe, null, Xt(e.items, (u, p) => (g(), C("div", {
          key: p,
          class: pe(["option", {
          ...
          T("span", av, B(u.date), 1),
          u.cost ? (g(), C("span", rv, " + € " + B(u.cost), 1)) : (g(), C("span", ov, B(o.value), 1))
        ], 2))), 128)),
        K(Pe, {
          variant: "tertiary",
...
const lv = {
  ...
  setup(e, { expose: t }) {
    ...
    function p(v = !1, $ = !1) {
      v && a.persistent && !$ || l.value && !$ || (l.value = !0, i.value = !1, n.value = 0, u(), s && (cancelAnimationFrame(s), s = null), c && (clearTimeout(c), c = null), d && clearTimeout(d), d = window.setTimeout(() => {
        o.value?.open && o.value.close(), r.value && (r.value = !1), l.value = !1;
      }, 300));
    }
    function h(v) {
      a.overlay && v.target === v.currentTarget && p(!0);
    }
    function f() {
      p(!1, !0);
    }
    ...
    function b() {
      ...
      if (c && (clearTimeout(c), c = null), v) {
        n.value = 0, u(), v.dispatchEvent(new CustomEvent("drawer:force-close")), c = window.setTimeout($, 300);
        return;
      }
      $();
    }
...
const Cv = {
...
}, So = /* @__PURE__ */ he(Pv, [["__scopeId", "data-v-175d52b3"]]), Bv = ["id", "value", "disabled", "required", "tabindex", "indeterminate", "true-value", "false-value"], Iv = {
  key: 0,
  class: "append"
}, jv = ["id"], Dv = {
  __name: "PCheckbox",
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = e, a = Qe(e, "modelValue"), r = t.required ? { checked: { required: Ke.withMessage(j("checkbox.required"), op(!0)) } } : null, o = aa(r, { checked: a }), i = P(() => `${t.id}-error`);
    return (n, l) => (g(), C("div", {
      ...
      k(o).checked?.$errors[0]?.$message ? (g(), C("span", {
        ...
        "aria-live": "assertive",
        class: "error-message"
      }, B(k(o).checked.$errors[0].$message), 9, jv)) : U("", !0)
    ], 2));
  }
}, Co = /* @__PURE__ */ he(Dv, [["__scopeId", "data-v-3dad8f2b"]]);
function Ra(e, t) {
...
const Lv = {
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    }), _ = P(() => o.requiredMessage ? o.requiredMessage : o.label ? j("input.required_with_label", { label: o.label.toLowerCase() }) : j("input.required")), S = P(() => o.required ? { value: { required: Ke.withMessage(() => _.value, ir) } } : { value: {} }), v = aa(S.value, { value: b }), $ = P(() => !o.required || o.required && !v.value?.$errors[0]), z = P(() => !!o.error || v.value?.$errors?.length > 0 || !$.value), X = P(() => Array.isArray(b.value) && b.value.length > 0), Z = P(() => `${o.id}-error`);
    function I(ee) {
      return o.itemValue ? ee[o.itemValue] : ee;
    }
    function F(ee) {
      return o.multiple ? o.modelValue?.includes(I(ee)) || !1 : b.value === I(ee);
    }
    function D(ee) {
      let me = null;
    ...
    function V(ee) {
      ...
      if (o.grouped) {
        const me = o.items.find(
          (ve) => ve[o.groupItems].find((ge) => I(ge) === ee)
        )[o.groupItems].find((ve) => I(ve) === ee);
        return D(me);
      }
      return !o.returnObject && o.itemValue ? D(o.items.find((me) => I(me) === ee)) : D(ee);
    }
    function M(ee) {
    ...
    function W(ee) {
      ...
      if (b.value.includes(I(ee))) {
        b.value = b.value.filter((me, ve) => ve !== b.value.indexOf(I(ee)));
        return;
      }
      b.value = [...b.value, I(ee)];
    }
    function E(ee) {
    ...
    function Se(ee, me) {
      p.value = ee, o.behavior === "manual" && (f.value = me.setActivator, w.value = me.toggle, y.value = me.onKeydown);
    }
    async function Ie() {
      return u;
    }
          ...
          o.items.length > 0 ? (g(), Y(Av, {
            ...
            default: O(({ item: ve }) => [
              o.grouped ? (g(), C(xe, { key: 0 }, [
                ...
                (g(!0), C(xe, null, Xt(ve[o.groupItems], (ge, it) => (g(), Y(So, {
                  key: it,
                  clickable: "",
                  active: F(ge),
                  text: D(ge),
              ...
              ], 64)) : D(ve) || ee.$slots.option ? (g(), Y(So, {
                key: 1,
                clickable: "",
                active: F(ve),
                text: D(ve),
            ...
            _: 3
          }, 8, ["items"])) : o.hideNoItemsLabel ? U("", !0) : (g(), C("div", Qv, B(o.noItemsLabel || k(j)("input.no_results")), 1)),
...
}, tm = /* @__PURE__ */ he(em, [["__scopeId", "data-v-7e184a2a"]]), am = {
  __name: "PCombobox",
  props: {
    ...zs,
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    function S(v) {
      ...
      v !== null && (h.value = !0, clearTimeout(u.value), u.value = setTimeout(() => {
        p.value && o("search", v), h.value = !1;
      }, 500));
    }
    return t({
      reset: f,
...
}, Si = /* @__PURE__ */ he(am, [["__scopeId", "data-v-0951cb5e"]]);
let $a = class {
  constructor(t = {}) {
...
const rm = { class: "sub-heading" }, om = { class: "actions" }, im = {
  ...
  setup(e) {
    ...
    const _ = q([]), S = P({
      ...
      width: {
        minValue: Ke.withMessage(
          ...
          qr(typeof $.value == "number" ? $.value : $.value.width)
        ),
        maxValue: Ke.withMessage(
          j("step.max_value", {
      ...
      height: {
        minValue: Ke.withMessage(
          ...
          qr(typeof $.value == "number" ? $.value : $.value.height)
        ),
        maxValue: Ke.withMessage(
          j("step.max_value", {
    ...
    })), Z = aa(X, S), I = P(() => r.value?.options?.some((M) => ["width", "height", "amount"].includes(M.code))), F = P(
    ...
    return (M, W) => (g(), Y(pv, {
      ...
      position: "right",
      title: k(j)("editor.editing_step", { step: r.value?.title }),
      persistent: k(Z).$errors.length > 0
    }, {
      default: O(() => [
        k(Z).$errors.length ? (g(), Y(lr, {
          key: 0,
          title: k(j)("editor.editor_alert.title"),
          description: k(j)("editor.editor_alert.description"),
          type: "error"
          ...
          default: O(() => [
            K(Tn, null, {
              default: O(() => [
                K(lt, null, {
                  title: O(() => [
                    oe(B(k(j)("editor.hide_step.title")), 1)
                  ]),
                  subtitle: O(() => [
                    oe(B(k(j)("editor.hide_step.description")), 1)
                  ]),
                  default: O(() => [
                    K(En, {
                      "model-value": !!i.value.overwrites.hide,
                      "onUpdate:modelValue": W[0] || (W[0] = (E) => p("hide", E))
                    }, null, 8, ["model-value"])
                  ]),
                  _: 1
                }),
                I.value ? U("", !0) : (g(), C(xe, { key: 0 }, [
                  K(lt, null, {
                    title: O(() => [
                      oe(B(k(j)("editor.default_option.title")), 1)
                    ]),
                    subtitle: O(() => [
                      oe(B(k(j)("editor.default_option.description")), 1)
                    ]),
                    default: O(() => [
                      K(Si, {
                        ...
                        "item-text": "title",
                        "item-value": "code",
                        placeholder: k(j)("editor.default_option.label"),
                        required: i.value.overwrites.hide,
                        "onUpdate:modelValue": W[1] || (W[1] = (E) => p("selected", E))
                  ...
                  F.value?.amount ? (g(), Y(lt, { key: 0 }, {
                    title: O(() => [
                      oe(B(k(j)("editor.default_option_value.title")), 1)
                    ]),
                    subtitle: O(() => [
                      oe(B(k(j)("editor.default_option_value.description")), 1)
                    ]),
                    default: O(() => [
                      K(mt, {
                        id: "default-value-input",
                        "model-value": i.value.overwrites.value,
                        placeholder: k(j)("editor.default_option_value.label"),
                        required: i.value.overwrites.hide,
                        ...
                        rules: [
                          ...
                          },
                          {
                            ...
                            message: k(j)("step.max_value", {
                              maxValue: F.value?.customInput?.max ?? 1 / 0
                            })
                          }
                        ],
                        "onUpdate:modelValue": W[2] || (W[2] = (E) => p("value", Number(E)))
                  ...
                  K(lt, null, {
                    title: O(() => [
                      oe(B(k(j)("editor.edit_title.title")), 1)
                    ]),
                    subtitle: O(() => [
                      oe(B(k(j)("editor.edit_title.description")), 1)
                    ]),
                    default: O(() => [
                      K(mt, {
                        ...
                        type: "text",
                        placeholder: k(j)("editor.edit_title.placeholder"),
                        "onUpdate:modelValue": W[3] || (W[3] = (E) => p("title", E))
                  ...
                  K(lt, null, {
                    title: O(() => [
                      oe(B(k(j)("editor.edit_description.title")), 1)
                    ]),
                    subtitle: O(() => [
                      oe(B(k(j)("editor.edit_description.description")), 1)
                    ]),
                    default: O(() => [
                      K(mt, {
                        ...
                        type: "text",
                        placeholder: k(j)("editor.edit_description.placeholder"),
                        "onUpdate:modelValue": W[4] || (W[4] = (E) => p("description", E))
                      }, null, 8, ["id", "model-value", "placeholder"])
                    ]),
                    _: 1
                  })
                ], 64)),
                T("h3", rm, B(k(j)("editor.edit_options")), 1)
              ]),
              _: 1
            }),
            K(ss, {
              ...
              items: r.value.options?.map((E) => ({
                ...E,
                title: E.title || k(j)(`editor.edit_option.${E.code}`)
              })),
              title: "title"
            }, {
              content: O((E) => [
                K(Tn, null, {
                  default: O(() => [
                    ["height", "width", "amount"].includes(E.code) ? (g(), Y(lt, { key: 0 }, {
                      title: O(() => [
                        oe(B(k(j)(`editor.${E.code}.title`)), 1)
                      ]),
                      default: O(() => [
                      ...
                      K(lt, null, {
                        title: O(() => [
                          oe(B(k(j)("editor.hide_option.title")), 1)
                        ]),
                        subtitle: O(() => [
                          oe(B(k(j)("editor.hide_option.description")), 1)
                        ]),
                        default: O(() => [
                          K(En, {
                      ...
                      K(lt, null, {
                        title: O(() => [
                          oe(B(k(j)("editor.edit_option_title.title")), 1)
                        ]),
                        subtitle: O(() => [
                          oe(B(k(j)("editor.edit_option_title.description")), 1)
                        ]),
                        default: O(() => [
                          K(mt, {
                            ...
                            type: "text",
                            placeholder: k(j)("editor.edit_option_title.placeholder"),
                      ...
                      K(lt, null, {
                        title: O(() => [
                          oe(B(k(j)("editor.edit_option_description.title")), 1)
                        ]),
                        subtitle: O(() => [
                          oe(B(k(j)("editor.edit_option_description.description")), 1)
                        ]),
                        default: O(() => [
                          K(mt, {
                      ...
                      K(lt, null, {
                        title: O(() => [
                          oe(B(k(j)("editor.edit_image.title")), 1)
                        ]),
                        subtitle: O(() => [
                          oe(B(k(j)("editor.edit_image.description")), 1)
                        ]),
                        default: O(() => [
                          K(mt, {
                            ...
                            type: "text",
                            placeholder: k(j)("editor.edit_image.placeholder"),
                      ...
                      K(lt, null, {
                        title: O(() => [
                          oe(B(k(j)("editor.edit_sequence.title")), 1)
                        ]),
                        subtitle: O(() => [
                          oe(B(k(j)("editor.edit_sequence.description")), 1)
                        ]),
                        default: O(() => [
                          K(mt, {
                            ...
                            type: "number",
                            placeholder: k(j)("editor.edit_sequence.placeholder"),
                            rules: [
                              {
                                validator: (Q) => Q >= 0,
                                message: k(j)("editor.min_sequence", {
                                  min: 0
                                })
                              },
                              {
                                validator: (Q) => Q <= r.value.options.length,
                                message: k(j)("editor.max_sequence", {
                                  max: r.value.options.length
                                })
                              },
                              {
                                message: k(j)("editor.number_should_not_exist_twice"),
...
function xm(e, t, a, r, o, i, n) {
  ...
  const s = l.map((p) => {
    ...
    const f = o?.find((b) => b.code === p.code)?.overwrites, w = ym(p.children, r, p.code, f?.options);
    let { code: y } = p;
      ...
      try {
        ...
        if ([r] = this.payload.products, typeof r == "object" && r) {
          ...
          if (r.can_order && Object.keys(this.address).length && this.address.city) {
            ...
            this.prices = _m(i, this.priceType), this.deliveryOptions = km(i, this.language), t || this.setOpenState();
...
const Am = {
  ...
  setup(e, { emit: t }) {
    ...
    async function d() {
      ...
      p.set("page[number]", n.value + 1), s.value && (a.filterKeys.length > 0 ? a.filterKeys.forEach((w) => {
        p.set(`filter[${w}]`, s.value);
...
const Tm = ["data-testid"], Om = {
  ...
  setup(e, { expose: t, emit: a }) {
    const r = e, o = a, i = Qe(e, "modelValue"), n = Tt("modal"), l = Tt("modal-content"), s = Tt("footer"), c = Tt("header"), d = q(!1), u = q(!1), p = q(!1), h = q(!1), f = q(!1), w = q(!1), y = q(!1), b = q(null), _ = q(null), S = q(null);
    let v = null;
    function $() {
      if (!l.value)
        return;
    ...
    function X(D) {
      o("minimize", D), d.value = D, u.value = !D;
    }
    function Z(D) {
    ...
    return ue(
      ...
      () => n.value,
      (D, V, M) => {
        D && (D.addEventListener("cancel", I), M(() => {
          D.removeEventListener("cancel", I);
        }));
      },
      { immediate: !0 }
    ), cr(() => {
      ...
      e.fullscreen && !d.value ? (g(), C("div", Om, [
      ...
      T("div", Vm, [
        e.hideHeader ? U("", !0) : (g(), C("header", {
          ...
          ie(D.$slots, "header", Va(no({ minimize: d.value })), () => [
            e.title ? (g(), Y($i, {
              key: 0,
              class: "title",
              level: "h2"
            ...
            !e.fullscreen && !e.hideCloseButton ? (g(), Y(Pe, {
              ...
              variant: "text",
              class: "close",
              "aria-label": k(j)("modal.close"),
              onClick: V[2] || (V[2] = (M) => {
                i.value = !1, o("close");
              })
            }, null, 8, ["icon", "aria-label"])) : U("", !0)
          ]),
          d.value && e.fullscreen ? (g(), C("div", Mm, [
            K(Pe, {
        ...
        !e.fullscreen && !e.hideFooter || !d.value && e.fullscreen && D.$slots.footer ? (g(), C("footer", {
          key: 2,
          ref: "footer",
          ...
          ie(D.$slots, "footer", {}, () => [
            e.fullscreen ? U("", !0) : (g(), C(xe, { key: 0 }, [
              K(Pe, {
                ...
                default: O(() => [
                  oe(B(e.secondaryButtonText ? e.secondaryButtonText : k(j)("modal.cancel")), 1)
                ]),
                _: 1
              }),
              K(Pe, {
                ...
                default: O(() => [
                  oe(B(e.primaryButtonText ? e.primaryButtonText : k(j)("modal.save")), 1)
                ]),
                _: 1
              })
            ], 64))
...
}, Bs = /* @__PURE__ */ he(Pm, [["__scopeId", "data-v-62575656"]]);
function Kt(e) {
...
const Lm = "Extended search is not available", Fm = "Logical search is not available", Nm = "Incorrect 'index' type", Rm = (e) => `Invalid value for key ${e}`, Um = (e) => `Pattern length exceeds max of ${e}.`, qm = (e) => `Missing ${e} property in key`, Hm = (e) => `Property 'weight' in key '${e}' must be a positive integer`, In = Object.prototype.hasOwnProperty;
class Km {
  constructor(t) {
  ...
  const o = (i, n, l) => {
    if (st(i))
      if (!n[l])
        ...
        if (!st(c))
          return;
        if (l === n.length - 1 && (Ot(c) || Is(c) || jm(c)))
          a.push(Im(c));
        else if (Kt(c)) {
          r = !0;
  ...
  for (let X = 0; X < d; X += 1) {
    ...
    for (; Z < I; )
      yr(t, {
        ...
        distance: o,
        ignoreLocation: c
      }) <= h ? Z = I : v = I, I = Math.floor((v - Z) / 2 + Z);
    v = I;
    let F = Math.max(1, p - I + 1), D = n ? u : Math.min(p + I, u) + d, V = Array(D + 2);
    V[D + 1] = (1 << X) - 1;
    for (let M = D; M >= F; M -= 1) {
      let W = M - 1, E = a[e.charAt(W)];
      if (w && (y[W] = +!!E), V[M] = (V[M + 1] << 1 | 1) & E, X && (V[M] |= (_[M + 1] | _[M]) << 1 | 1 | _[M + 1]), V[M] & $ && (S = yr(t, {
        errors: X,
        currentLocation: W,
        expectedLocation: p,
        distance: o,
...
class o0 {
  ...
  searchIn(t) {
    ...
    this.chunks.forEach(({ pattern: w, alphabet: y, startIndex: b }) => {
      const { isMatch: _, score: S, indices: v } = a0(t, w, y, {
        location: i + b,
        distance: n,
        threshold: l,
        findAllMatches: s,
...
const Go = {
  ...
  PATH: "$path",
  PATTERN: "$val"
}, Yo = (e) => !!(e[Go.AND] || e[Go.OR]), i0 = (e) => !!e[Jo.PATH], n0 = (e) => !Kt(e) && js(e) && !Yo(e), Fn = (e) => ({
...
class ba {
  ...
  search(t, { limit: a = -1 } = {}) {
    ...
    return s0(s, { ignoreFieldNorm: l }), i && s.sort(n), Is(a) && a > -1 && (s = s.slice(0, a)), u0(s, this._docs, {
      includeMatches: r,
      includeScore: o
    });
  }
...
const p0 = {
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    function w(I) {
      if (I?.item) {
        if (u.value.includes(".")) {
          const F = Ra(I.item, u.value);
          return Vn(F) ? F : "";
        }
        return u.value ? I.item[u.value] : I.item;
      }
      if (I) {
        if (u.value.includes(".")) {
          const F = Ra(I, u.value);
          return Vn(F) ? F : "";
        }
        return u.value ? I[u.value] : I;
      }
      return null;
    }
    function y(I) {
      return I?.item ? p.value.includes(".") ? Ra(I.item, p.value) : p.value ? I.item[p.value] : I.item : I ? p.value.includes(".") ? Ra(I, p.value) : p.value ? I[p.value] : I : null;
    }
    const b = P({
      get() {
        return r.modelValue;
    ...
    const z = P(() => _.value && !r.endpoint ? f.search(_.value) : r.items), X = Be({
      ...
      set(I) {
        o("update:show", I), I || o("close");
      }
    });
    return ue(i, (I) => {
      I && r.hotkey && setTimeout(() => {
      ...
      K(Bs, {
        ...
        default: O(() => [
          e.loading ? (g(), Y(fr, { key: 0 })) : !e.loading && e.endpoint ? (g(), Y(Am, Me({
            key: 1,
            modelValue: b.value,
            ...
            inline: O(() => [
              K(Pe, {
                ...
                default: O(() => [
                  oe(B(e.buttonText || k(j)("input.cancel")), 1)
                ]),
                _: 1
              })
            ]),
...
const m0 = {
  ...
  setup(e, { emit: t }) {
    ...
    }), i = P(() => a.placeholder ? a.placeholder : j("input.product_reference"));
  ...
  setup(e, { expose: t, emit: a }) {
    const r = e, o = a, i = Tt("submit-button"), n = q(!1), l = q(null), s = q(null), c = P(() => r.submit ? r.submit : j("product-config-modal.add_to_cart")), d = P(() => r.submit ? r.submit : j("product-config-modal.add")), u = P(() => r.priceSubtext ? r.priceSubtext : j("product-config-modal.price_excluding")), p = P(() => {
    ...
    return ue(
      ...
      header: O(() => [
        ...
        T("div", g0, [
          ...
          !n.value && e.subTitle ? (g(), C("span", b0, [
          ...
          }, null, 8, ["modelValue"])) : n.value && l.value ? (g(), C("span", w0, [
            oe(B(w.referenceLabel) + ": ", 1),
            T("span", y0, B(l.value), 1)
          ])) : U("", !0)
        ]),
        !n.value && e.showReferenceField ? (g(), Y(Nn, {
          key: 1,
      ...
      footer: O(() => [
        T("div", x0, [
          e.specs ? (g(), Y(Pe, {
            ...
            default: O(() => [
              oe(B(k(j)("product-config-modal.specifications")), 1)
            ]),
            _: 1
          })) : U("", !0),
          T("div", k0, [
            p.value ? (g(), C("div", _0, [
              T("span", {
                ...
                e.extendedPricing ? (g(), C("span", $0, B(k(j)("product-config-modal.total")), 1)) : U("", !0),
                T("span", null, B(p.value.whole), 1),
                T("span", S0, B(p.value.decimal), 1)
              ], 2),
              e.extendedPricing ? (g(), C(xe, { key: 0 }, [
                T("span", C0, [
                  T("span", A0, B(k(j)("product-config-modal.shipping_costs")), 1),
                  T("span", z0, B(k(Ao)(e.product.shipping, e.lang, e.currency)), 1)
                ]),
                T("span", E0, [
                  T("span", T0, B(k(j)("product-config-modal.packaging_costs")), 1),
                  T("span", O0, B(k(Ao)(e.product.packaging, e.lang, e.currency)), 1)
                ])
              ], 64)) : (g(), C("span", V0, B(u.value), 1))
            ])) : U("", !0),
            K(Pe, {
              ref: "submit-button",
              disabled: !e.canOrder,
              ...
              default: O(() => [
                T("span", M0, B(c.value), 1),
                T("span", P0, B(d.value), 1)
              ]),
              _: 1
            }, 8, ["disabled", "icon"])
          ])
...
}, I0 = /* @__PURE__ */ he(B0, [["__scopeId", "data-v-ebaf50db"]]), j0 = { class: "modal-container" }, D0 = { class: "option" }, L0 = { key: 0 }, F0 = { class: "title" }, N0 = {
  key: 0,
  class: "subtitle"
  ...
  setup(e) {
    ...
    return ue(n, async () => {
      ...
      K(k(h0), {
        ...
        option: O(({ option: d }) => [
          T("span", D0, [
            d && d.translations[i.value.language] ? (g(), C("span", L0, [
              T("span", F0, B(d.translations[i.value.language].title), 1),
              d.translations[i.value.language].description ? (g(), C("span", N0, B(d.translations[i.value.language].description), 1)) : U("", !0)
            ])) : d && d.translations.nl ? (g(), C("span", R0, [
              T("span", U0, B(d.translations.nl.title), 1),
              d.translations.nl.description ? (g(), C("span", q0, B(d.translations.nl.description), 1)) : U("", !0)
            ])) : U("", !0)
          ])
        ]),
        _: 1
...
}, xr = /* @__PURE__ */ W0(J0, [["styles", [K0]]]), Y0 = /* @__PURE__ */ lu({
  ...xr,
  setup(e, t) {
